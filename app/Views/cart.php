        ...
        if (getCookie('inventory')) {
            ...
            if (cookie_products.length > 0) {
                $.each(cookie_products, function(ci, cv) {
                    ...
                    itemnary_template += '<button class="btn btn-transparent p-1" type="button" onclick="decrement_copy($(this),' + ci + ');">' + ((cv['copies'] > 1) ? '<i class="fa fa-minus text-dark"></i>' : '<i class="fa-solid fa-trash-can"></i>') + '</button>';
                    ...
                    itemnary_template += '<button class="btn btn-transparent p-1" type="button" onclick="increment_copy($(this),' + ci + ');"><i class="fa fa-plus text-dark"></i></button>';
                    itemnary_template += '</div>';
